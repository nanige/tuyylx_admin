            ...
            <Col :span="spanRight">
                ...
                <div class="screen" :style="'height:' + height2">
                    ...
                    <table v-if="tableShow2">
                        <tr>
                            <td style="width:50px;font-weight: 600">价格</td>
                            <td>不限</td>
                            <td>低于500</td>
                            <td>500-1000</td>
                            <td>1000-1500</td>
                        ...
                        <tr>
                            <td style="width:50px;font-weight: 600">主题</td>
                            <td>不限</td>
                            <td>高铁旅游</td>
                            <td>高铁旅游</td>
                            <td>高铁旅游</td>
                        ...
                        <tr>
                            <td style="width:50px;font-weight: 600">推广</td>
                            <td>不限</td>
                            <td>非常1+1</td>
                            <td>非常1+1</td>
                            <td>非常1+1</td>
                        ...
                        <tr>
                            <td style="width:50px;font-weight: 600">销售</td>
                            <td>不限</td>
                            <td>急推</td>
                            <td>急推</td>
                            <td>急推</td>
                        ...
                        <tr>
                            <td style="width:50px;font-weight: 600">其它</td>
                            <td>不限</td>
                            <td>仅显示可收客户</td>
                        </tr>
                        <tr>
                            <td style="width:50px;font-weight: 600">WIFI</td>
                            <td>不限</td>
                        </tr>
                    </table>
                </div>
                    ...
                    render: (h, params) => {
                        return h('div', [
                            h('Button', {
                                ...
                                on: {
                                    click: () => {
                                        this.toReservation (params.row.lineDBname,params.row.groupno,params.row.dbName)
                                    }
                                }
                            }, '预订')
                        ]);
