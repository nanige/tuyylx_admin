                ...
                <Row>
                    <Col span="10">
                        <Form-item label="经销商编号：" prop="venCode">
                            <Input v-model="operator.venCode" :maxlength="20" placeholder="数字字母组合长度小于20 例：A12"></Input>
                        </Form-item>
                    </Col>
                ...
                <Row>
                    <Col span="24">
                        <Form-item label="经销商名称：" prop="venName">
                            <Input v-model="operator.venName" placeholder="数字字母组合长度小于100 例：广州途优游信息科技有限公司"></Input>
                        </Form-item>
                    </Col>
                </Row>
                <Row>
...
<script>
  ...
  export default {
    ...
    methods: {
        submitFn (name) {
            this.self.addSupplier (this.operator)
        },
        chooseAreaBig () {
